        ...
        <div className={`sticky top-0 z-30 transition-all duration-300 ${darkMode ? 'bg-gray-950/80 border-gray-800' : 'bg-white/80 border-gray-200'} backdrop-blur-lg border-b`}>
          <div className="flex items-center justify-between px-6 py-2">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {config.actions && (
                <div className="inline-flex items-center gap-1 p-1 rounded-full bg-blue-600 hover:bg-blue-700 transition-colors duration-300 cursor-pointer">
                  {config.actions}
                </div>
              )}
              <div className={`inline-flex items-center gap-1 px-2 py-1.5 rounded-full border transition-colors duration-300 ${darkMode ? 'bg-gray-900 border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
                {toolbarButtons}
              </div>
            </div>
          </div>
        ...
        <div className="sticky top-0 z-30 pointer-events-none">
          <div className="flex items-center justify-between px-6 pt-4 pb-0">
            ...
            <div className="flex items-center gap-2 pointer-events-auto">
              {config.actions && (
                <div className="inline-flex items-center gap-1 p-1 rounded-full shadow-lg bg-blue-600 hover:bg-blue-700 transition-colors duration-300 cursor-pointer shadow-blue-500/30">
                  {config.actions}
                </div>
              )}
