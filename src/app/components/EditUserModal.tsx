...
export function EditUserModal({ isOpen, onClose, onSave, userData }: EditUserModalProps) {
            ...
            <div className="relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-7 pr-2 py-1.5 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500/30 focus:border-blue-500 text-sm transition-all"
                  placeholder="Buscar roles..."
                />
              </div>

              {isRoleDropdownOpen && (
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg max-h-40 overflow-y-auto" ref={roleDropdownRef}>
                    ...
                    filteredRoles.map(role => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full px-2.5 py-1.5 text-left hover:bg-gray-50 flex items-start gap-2 border-b border-gray-100 last:border-b-0"
                        >
                          <div className={`flex-shrink-0 w-3.5 h-3.5 mt-0.5 rounded border ${
                            isSelected 
              ...
              {Object.entries(permissionsByCategory).map(([category, permissions]) => (
                <div key={category} className="border-b border-gray-200 last:border-b-0">
                  <button
                    ...
                    className="w-full px-2.5 py-1.5 bg-gray-50 hover:bg-gray-100 flex items-center justify-between text-xs font-medium text-gray-700 transition-colors"
                  >
                    <span>{category}</span>
                    <ChevronDown
                      size={14}
                  ...
                  {expandedCategories.includes(category) && (
                    <div className="bg-white">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 px-2.5 py-1.5 border-b border-gray-100 transition-colors">
                        <input
                          type="checkbox"
                                  ...
                                  {permission.children.map(childId => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        />
                                        <span className="text-xs text-gray-600">{childPermission.name}</span>
                                      </label>
                                    );
                                  })}
                                </div>
